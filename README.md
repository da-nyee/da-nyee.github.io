...
- [[Effective Java] 아이템 4. 인스턴스화를 막으려거든 private 생성자를 사용하라](https://da-nyee.github.io/posts/effective-java-item-4/)
...
- [[Database] NoSQL에서도 트랜잭션 개념이 적용될까?](https://da-nyee.github.io/posts/nosql-with-transaction/)
...
#### Fintech
- [[Fintech] VAN vs PG, 그리고 간편 결제](https://da-nyee.github.io/posts/fintech-van-vs-pg-and-easy-payment/)
...
- [[Network] HTTP 1.0 vs HTTP 1.1 vs HTTP 2.0](https://da-nyee.github.io/posts/network-http1.0-vs-http1.1-vs-http2.0/)
